...
input_chars = ['a', 'b']  
final_states = [2, 3]  
transition_table = [[1, 4], [3, 2],[2, 2],[3, 3],[4, 4]]
dfa = DFA(5, input_chars, 0, final_states, transition_table)

print("DFA of (ab+aa)(a+b)*: String that starts with either 'ab' OR with 'aa'.")
word = input('Input: ')
try:
